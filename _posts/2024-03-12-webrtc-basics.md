...
excerpt: "별도의 플러그인 없이 웹 브라우저 간에 오디오, 비디오, 데이터를 실시간으로 전송할 수 있는 WebRTC의 기본 개념에 대해 알아보자"
---
...
<div class="sleek-diagram-container" style="margin: 24px 0;">
  <!-- Phase 1: Signaling -->
  <div class="diagram-flow">
    <div class="flow-node">
      <span class="node-title">Peer A</span>
      <span class="node-subtitle">브라우저</span>
    </div>
    <div class="flow-arrow">&leftrightarrow;</div>
    <div class="flow-node websocket-node">
      <span class="node-title">시그널링 서버</span>
      <span class="node-subtitle">접속 정보 교환</span>
    </div>
    <div class="flow-arrow">&leftrightarrow;</div>
    <div class="flow-node">
  ...
  <div class="diagram-flow" style="margin-top: 8px;">
    <div class="flow-node" style="border-color: #34c759; background: rgba(52, 199, 89, 0.02);">
      <span class="node-title" style="color: #34c759;">Peer A</span>
    </div>
    <div class="flow-arrow flow-arrow-success" style="font-size: 13px; font-weight: 700;">
      &larr; P2P 직접 연결 (RTCDataChannel) &rarr;
    </div>
    <div class="flow-node" style="border-color: #34c759; background: rgba(52, 199, 89, 0.02);">
      <span class="node-title" style="color: #34c759;">Peer B</span>
    </div>
  </div>
</div>
<p class="diagram-caption">그림 1: WebRTC 아키텍처. 시그널링 서버를 통해 브라우저 간의 메타데이터를 교환한 후, 최종적으로 직접(P2P) 통신 경로를 만듭니다.</p>
